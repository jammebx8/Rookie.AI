      ...
      <div className="sticky top-0 z-30 bg-black/95 backdrop-blur-sm border-b border-[#232B3B]">
        ...
        <div className="px-6 pb-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="w-48 h-2 bg-[#151B27] rounded-full overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
                      ...
                      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6">
                        <div className="flex items-center gap-3">
                          <motion.div
                            ...
                            className="w-6 h-6 border-2 border-white border-t-transparent rounded-full"
                          />
                          <span>Generating motivation...</span>
                        </div>
                      </div>
                    ) : (
                      motivation && (
                            ...
                            {!aiFollowup && !aiFollowupLoading && (
                              <div className="flex flex-wrap gap-3">
                                <motion.button
                                  ...
                                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600 text-white disabled:opacity-50 hover:bg-blue-700 transition-colors"
                                >
                                ...
                                <motion.button
                                  ...
                                  disabled={aiFollowupLoading}
                                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600 text-white disabled:opacity-50 hover:bg-purple-700 transition-colors"
                                >
